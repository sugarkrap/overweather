...
![Old concept](old.png)
Each parameter, especially the personal history, made it so I could figure out a weather score. And at first, it seemed rather promising but... Something felt off. So I've added a match saving feature. And then that's when it occurred to me: across two accounts, out of a sample of 166 matches, I've got a win rate of 48%, even when playing when the "weather" was at >70 out of 100. True, the sample rate is small, but this means that logically, the winrate didn't move.
...
Also, this means the system has become quite sophisticated, at least on my two accounts: I've never seen any Reversal in months. So it means that the matchmaking can prepare matches just so right, that it never needs to tell the user "oh well, I've prepared a win for you and you threw it away".
